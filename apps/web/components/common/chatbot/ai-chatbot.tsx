...
export function AIChatbot() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-end p-4 pointer-events-none sm:p-6">
      <div className="flex flex-col w-full max-w-md h-[600px] bg-card border border-border rounded-2xl shadow-2xl pointer-events-auto overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-muted">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="text-sm font-semibold text-foreground">AI Support</h3>
              <p className="text-xs text-muted-foreground">Need Help & Ask</p>
            </div>
          </div>
          <Button
            variant="ghost"
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-4 space-y-4 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-muted [&::-webkit-scrollbar-thumb]:bg-muted-foreground/40 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:hover:bg-muted-foreground/60">
          {messages.length === 0 ? (
                  ...
                  <LinkifiedMessage
                    ...
                    linkClassName={
                      message.role === "user"
                        ...
                        : "break-all font-medium text-blue-300 underline decoration-blue-400/60 underline-offset-2 hover:text-foreground"
                    }
                  />
                  <span
