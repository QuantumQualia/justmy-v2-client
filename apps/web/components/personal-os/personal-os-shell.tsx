...
import { PersonalOsSubnav } from "@/components/personal-os/personal-os-ui";
...
export function PersonalOsShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    if (isError) router.push("/login?redirect=/personal-os");
  }, [isError, router]);
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      document.documentElement.style.removeProperty("--personal-os-sticky-top");
    };
  }, [newsHost, market]);
