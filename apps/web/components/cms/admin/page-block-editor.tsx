...
export function PageBlockEditor({
  ...
  const renderBlockEditor = () => {
    switch (block.blockType) {
      ...
      case "myform-management-block":
        return <MyformManagementBlockEditor block={block} onUpdate={onUpdate} />;
            ...
            <div className="border-t border-border pt-4 mt-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-3">
                  <h4 className="text-xs font-medium text-muted-foreground">Spacing</h4>
                  <div>
                    <Label className="text-xs text-muted-foreground">Padding (per side)</Label>
                  ...
                  <div>
                    <Label className="text-xs text-muted-foreground">Margin (per side)</Label>
                    <div className="mt-1 grid grid-cols-2 gap-2">
                      <div>
                        <Label className="text-[10px] text-muted-foreground">Top</Label>
                        <input
                ...
                <div className="space-y-3">
                  <h4 className="text-xs font-medium text-muted-foreground">Layout & Border</h4>
                  <div>
